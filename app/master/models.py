...
class Persona(models.Model):
    ...
    """
    numero_identificacion = models.CharField(max_length=25, unique=True, blank=False, null=False)
    ...
    tipo_documento_identificacion = models.ForeignKey('master.Item', on_delete=models.CASCADE,
                                                      related_name='tipo_documento_identificacion')
    genero = models.ForeignKey('master.Item', related_name='genero', on_delete=models.CASCADE)
    estado_civil = models.ForeignKey('master.Item', related_name='estado_civil', on_delete=models.CASCADE)
...
class Direccion(models.Model):
    ...
    tipo_direccion = models.ForeignKey('master.Item', related_name='tipo_direccion', on_delete=models.CASCADE)
    numero_telefono = models.CharField(max_length=500, blank=True, null=True)
    persona = models.ForeignKey('master.Persona', related_name='direcciones', on_delete=models.CASCADE)
...
class Catalogo(models.Model):
    codigo = models.CharField(max_length=25, blank=False, null=False, unique=True)
    nombre = models.CharField(max_length=250, blank=False, null=False)
    descripcion = models.TextField(max_length=500, null=True, blank=True)
    estado = models.BooleanField(default=True)
    empresa = models.ForeignKey('master.Empresa', related_name='catalogos', on_delete=models.CASCADE)
...
class Item(models.Model):
    ...
    estado = models.BooleanField(default=True)
    catalogo = models.ForeignKey('master.Catalogo', related_name='items', on_delete=models.CASCADE)
...
class Parametrizacion(models.Model):
    ...
    estado = models.BooleanField(default=True)
    empresa = models.ForeignKey('master.Empresa', related_name='parametrizaciones', on_delete=models.CASCADE)
...
class DetalleParametrizacion(models.Model):
    ...
    parametrizacion = models.ForeignKey('master.Parametrizacion', related_name='detalles', on_delete=models.CASCADE)
